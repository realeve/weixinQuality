	...
	module.exports = {
		"part0": {
			...
			"data": [
				...
				{
					"title": "每年(  )月份在全国开展质量月活动，宣传&quot;质量第一&quot;的思想。",
					"answer": 3,
					"question": [
						"3",
						"6",
		...
		"part5": {
			...
			"data": [
				...
				{
					"title": " 图像采集部件的作用是采集原始的模拟图像数据，并将其转换成（  ）",
					"answer": 2,
					"question": [
						" 模拟信号",
						" 数字信号"
				...
				{
					"title": "量化是把抽样后所得的连续量表示的像素值离散化为（）的操作。",
					"answer": 1,
					"question": [
						"整数值",
						"小数值",
		...
		"part6": {
			...
			"data": [
				...
				{
					"title": "ISO9000族标准自发布后至今已有 国家和地区采用了这套标准。（  ）",
					"answer": 2,
					"question": [
						"100多个",
						"150多个",
				...
				{
					"title": "ISO9000：2000标准表述了建立和运行质量管理体系应遵循的 方面的质量管理体系基础知识。（  ）",
					"answer": 3,
					"question": [
						"8个 ",
						"10个",
				...
				{
					"title": "从国外工业发达国家的情况来看，质量管理的发展大体经历了质量检验、统计质量控制和 三个阶段。（  ）",
					"answer": 1,
					"question": [
						"全面质量管理",
						"外观质量管理",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WINDOWTITLE = __webpack_require__(54);
	...
	var app = function() {
		...
		function getPaper() {
			var question = __webpack_require__(48)("./" + exam.examPaper + '.json');
			//普通答题，直接载入即可
			if (exam.type == '0') {
